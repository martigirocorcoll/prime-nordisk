...
class InvestmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Investment" do
    ...
    fill_in "Direccion", with: @investment.direccion
    fill_in "Estado", with: @investment.estado
    fill_in "Gastos", with: @investment.gastos
    fill_in "Precio adquisicion", with: @investment.precio_adquisicion
    fill_in "Precio venta", with: @investment.precio_venta
