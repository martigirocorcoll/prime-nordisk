...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post investments_url, params: { investment: { direccion: @investment.direccion, estado: @investment.estado, gastos: @investment.gastos, precio_adquisicion: @investment.precio_adquisicion, precio_venta: @investment.precio_venta } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { direccion: @investment.direccion, estado: @investment.estado, gastos: @investment.gastos, precio_adquisicion: @investment.precio_adquisicion, precio_venta: @investment.precio_venta } }
