...
class CompradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comprador" do
    assert_difference('Comprador.count') do
      post compradors_url, params: { comprador: { contacto: @comprador.contacto, mail: @comprador.mail, nombre: @comprador.nombre } }
    end
  ...
  test "should update comprador" do
    patch comprador_url(@comprador), params: { comprador: { contacto: @comprador.contacto, mail: @comprador.mail, nombre: @comprador.nombre } }
