...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { expense_id: @pago.expense_id, fecha: @pago.fecha, pagador_id: @pago.pagador_id, quantitat: @pago.quantitat } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { expense_id: @pago.expense_id, fecha: @pago.fecha, pagador_id: @pago.pagador_id, quantitat: @pago.quantitat } }
