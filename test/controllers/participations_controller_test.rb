...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post participations_url, params: { participation: { data: @participation.data, investment_id: @participation.investment_id, quantitat_invertida: @participation.quantitat_invertida, user: @participation.user } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { data: @participation.data, investment_id: @participation.investment_id, quantitat_invertida: @participation.quantitat_invertida, user: @participation.user } }
