class InvestmentsController < ApplicationController
  ...
  private
    ...
    def investment_params
      params.require(:investment).permit(:direccion, :precio_venta, :precio_adquisicion, :gastos, :estado, :poblacion, :description, :photo, :analisis, :google_location, documentos: [])
    end
end
